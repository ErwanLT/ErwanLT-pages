...
permalink: "/springboot/integration-de-thymeleaf-dans-une-application-spring-boot/"
tags: [back, java, spring-boot, thymeleaf, tutoriel]
source: "sfeir.dev"
...
[Spring Boot](/springboot/il-etait-une-fois-spring-boot/) repose largement sur le modèle **MVC (Model-View-Controller)**, une architecture qui sépare les responsabilités de l’application en trois couches distinctes :
...
[Papa, je veux un Pokédex - partie 2](/springboot/papa-je-veux-un-pokedex-partie-2/)
