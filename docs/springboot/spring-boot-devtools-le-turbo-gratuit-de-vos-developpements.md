...
permalink: "/springboot/spring-boot-devtools-le-turbo-gratuit-de-vos-developpements/"
...
- **LiveReload** : serveur LiveReload embarqué qui peut rafraîchir automatiquement le navigateur quand des ressources statiques ou des templates changent (utile lorsque l'on utilise **[thymeleaf](/springboot/integration-de-thymeleaf-dans-une-application-spring-boot/)**).
...
Ça marche particulièrement bien quand on utilise [Thymeleaf](/springboot/integration-de-thymeleaf-dans-une-application-spring-boot/) : le cycle devient presque instantané.
...
Et quand on le combine avec [Thymeleaf](/springboot/integration-de-thymeleaf-dans-une-application-spring-boot/) ou des outils d’observabilité comme [Superviser votre application Spring Boot grâce à Prometheus et Grafana](/springboot/superviser-votre-application-spring-boot-grace-a-prometheus-et-grafana/), le confort de dev devient franchement agréable.
