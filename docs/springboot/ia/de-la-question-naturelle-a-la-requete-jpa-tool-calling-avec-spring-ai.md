...
permalink: "/springboot/ia/de-la-question-naturelle-a-la-requete-jpa-tool-calling-avec-spring-ai/"
tags: [spring-boot, java, tutoriel, ia]
---
Dans [Et si on intégrait LangChain dans Spring Boot ? Partie 1](/springboot/ia/et-si-on-integrait-langchain-dans-spring-boot-partie-1/), nous avons branché un [LLM](https://www.sfeir.dev/data/comment-demarer-un-projet-llm/).  
Dans [Et si on intégrait LangChain dans Spring Boot ? Partie 2](/springboot/ia/et-si-on-integrait-langchain-dans-spring-boot-partie-2/) nous avons commencé à parler de tools.
...
- [Spring Boot](/springboot/il-etait-une-fois-spring-boot/)
...
- [De la validation en entrée](/springboot/validation-spring-boot-du-standard-au-sur-mesure/) pour valider les entrées API,
- [De la gestion de profil](/springboot/les-profils-dans-spring-boot/) pour séparer config locale et environnements,
- [Du monitoring pour surveiller les instances](/springboot/superviser-votre-application-spring-boot-grace-a-prometheus-et-grafana/).
