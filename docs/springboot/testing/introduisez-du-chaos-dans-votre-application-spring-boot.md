---
layout: "default"
title: "Introduisez du chaos dans votre application Spring Boot"
permalink: "/springboot/testing/introduisez-du-chaos-dans-votre-application-spring-boot/"
tags: [back, java, spring-boot, chaos, chaos engineering, tutoriel, testing]
source: "sfeir.dev"
source_url: "https://www.sfeir.dev/back/introduisez-du-chaos-dans-votre-application-spring-boot/"
banner: "https://www.sfeir.dev/content/images/2025/08/20250827_0919_Colorful-Spring-Boot-Chaos_remix_01k3n66r94fe6s85jnzskv1c7w.png"
published_at: "2025-02-24"
sfeir_slug: "introduisez-du-chaos-dans-votre-application-spring-boot"
date: "2025-02-24"
---
...
Et c'est ce que nous allons voir dans cet article en introduisant divers types de chaos dans une application [Spring Boot](/springboot/il-etait-une-fois-spring-boot/).
...
Au démarrage de votre application, en plus de la traditionnelle bannière Spring ([si vous n'avez pas personnalisé celle-ci](/springboot/comment-personnaliser-la-banniere-d-un-projet-spring-boot/)) vous devriez voir dans vos logs ceci :
...
Pour profiter de cette fonctionnalité, il faut au préalable avoir inclus les actuators dans vos dépendances, et pour les plus curieux qui veulent avoir les différents contrats des APIs l'on peut également ajouter celle de l'UI de [swagger](/springboot/reussir-sa-migration-de-swagger-2-a-openapi-3/):
...
Avec l'aide de [Spring AOP](https://www.sfeir.dev/back/spring-aop-comprendre-la-programmation-orientee-aspect-dans-spring/), Chaos Monkey détecte l'exécution d'une méthode publique dans un bean surveillé et choisira soit de ne rien faire, soit de lancer une de ses attaques.  
