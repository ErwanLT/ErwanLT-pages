...
permalink: "/springboot/spring-aop-comprendre-la-programmation-orientee-aspect-dans-spring/"
tags: [back, spring-boot, aop, java, tutoriel]
source: "sfeir.dev"
...
La solution la plus simple si vous êtes dans un contexte [d'application Spring Boot](/springboot/il-etait-une-fois-spring-boot/) est de rajouter la [dépendance au starter AOP](https://www.sfeir.dev/back/how-to-trouver-ses-starters-springboot/).
...
- `@annotation(MyCustomAnnotation)` : cible les méthodes annotées. (pour un exemple de cette dernière, [allez lire la série sur les BRMS](/springboot/brms/maitrisez-vos-regles-metier-integrez-drools-dans-spring-boot/)
