---
layout: "default"
title: "Générer vos clients d'API à partir de leur spécification OpenAPI"
permalink: "/springboot/generer-vos-clients-d-api-a-partir-de-leur-specification-openapi/"
tags: [back, java, spring-boot, openapi, swagger, codegen, maven, tutoriel]
source: "sfeir.dev"
source_url: "https://www.sfeir.dev/back/generer-vos-client-dapi-a-partir-de-leur-specification-openapi/"
banner: "https://www.sfeir.dev/content/images/2025/08/20250828_0911_Pixelated-Codegen-Magic_simple_compose_01k3qr5dh0fq1aztzzcwfe23zf.png"
published_at: "2025-04-23"
sfeir_slug: "generer-vos-client-dapi-a-partir-de-leur-specification-openapi"
date: "2025-04-23"
---
...
- **Compatibilité avec les frameworks** : Il prend en charge des bibliothèques populaires comme **Spring** (avec [spring-boot](/springboot/il-etait-une-fois-spring-boot/) ou spring-cloud pour OpenFeign), ce qui facilite son intégration dans des projets existants.
...
- **Génération** : Exécutez `mvn generate-sources`. Cela crée une interface `BookManagementApi` [annotée](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) avec `@FeignClient` dans `fr.eletutour.book.consumer.api`.
- **Service Spring** :
