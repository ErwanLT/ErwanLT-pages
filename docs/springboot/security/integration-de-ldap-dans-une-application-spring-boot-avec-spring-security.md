...
permalink: "/springboot/security/integration-de-ldap-dans-une-application-spring-boot-avec-spring-security/"
tags: [back, java, spring-boot, spring security, ldap, tutoriel, securite]
source: "sfeir.dev"
...
date: "2026-03-06"
---
De nombreuses applications modernes doivent gérer [l’authentification des utilisateurs](/springboot/security/securisez-vos-api-avec-spring-security-basic-auth/) et leurs autorisations. Plutôt que de recréer un système interne, les entreprises centralisent souvent cette gestion via un **annuaire LDAP**. Dans cet article, nous allons voir comment configurer une [application **Spring Boot**](/springboot/il-etait-une-fois-spring-boot/) pour s’appuyer sur LDAP.  
...
Nous protégeons également nos endpoints `listUsers` et `createUser` aux [utilisateurs ayant le rôle](/springboot/security/securisez-vos-api-avec-spring-security-acces-par-role/) **ADMIN** via [l'annotation](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) `@PreAuthorize("hasRole('ADMINS')")` .
