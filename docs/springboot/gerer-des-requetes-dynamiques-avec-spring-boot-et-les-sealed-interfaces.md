...
permalink: "/springboot/gerer-des-requetes-dynamiques-avec-spring-boot-et-les-sealed-interfaces/"
...
Grâce [aux annotations](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) Jackson, nous mettons en place le mécanisme de polymorphisme :
...
Les annotations SpringDoc (`@Operation`, etc.) sont utilisées pour [générer une documentation d'API](/springboot/reussir-sa-migration-de-swagger-2-a-openapi-3/) claire, qui reflète bien la nature polymorphique de l'objet attendu.
