...
permalink: "/springboot/papa-je-veux-un-pokedex-partie-1/"
tags: [back, postman, html, css, javascript, pokedex, spring-boot, java, tutoriel]
source: "sfeir.dev"
...
Découvrez la suite de la création d'un Pokédex dans [le prochain article](/springboot/papa-je-veux-un-pokedex-partie-2/) !
