...
permalink: "/springboot/mise-en-place-de-r2dbc-dans-une-application-spring-boot/"
tags: [back, java, spring-boot, r2dbc, reactive, tutoriel]
source: "sfeir.dev"
...
C’est dans ce contexte qu’apparaît **R2DBC**, une nouvelle manière de communiquer avec une base relationnelle au sein de [Spring Boot](/springboot/il-etait-une-fois-spring-boot/).
...
Dans une application Spring traditionnelle, on expose des [REST - définition](/definition/rest-definition/) avec des classes [annotées](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) `@RestController` et des méthodes annotées `@GetMapping`, `@PostMapping`, etc.  
