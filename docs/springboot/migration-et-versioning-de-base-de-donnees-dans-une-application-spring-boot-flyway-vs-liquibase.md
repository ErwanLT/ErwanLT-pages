...
permalink: "/springboot/migration-et-versioning-de-base-de-donnees-dans-une-application-spring-boot-flyway-vs-liquibase/"
tags: [back, spring-boot, database, flyway, liquibase, java, tutoriel]
source: "sfeir.dev"
...
[Spring Boot](/springboot/il-etait-une-fois-spring-boot/) **auto-configure****Flyway** dès qu’il détecte cette dépendance. Ensuite, dans `application.properties` :
