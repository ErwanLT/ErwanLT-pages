...
permalink: "/springboot/les-profils-dans-spring-boot/"
...
date: "2026-03-01"
---
Dans toute application [Spring Boot](/springboot/il-etait-une-fois-spring-boot/) un tant soit peu sérieuse, une question finit toujours par se poser :
...
C'est ici que les profils deviennent vraiment puissants. Ils permettent de conditionner l'existence même d'un composant Java grâce à [l'annotation](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) `@Profile`.
