...
permalink: "/springboot/graphql/partie-1-mise-en-place/"
...
L’arme qui donne à notre équipage tout le pouvoir de GraphQL ! Elle simplifie grandement l’intégration de GraphQL dans Spring Boot, en nous permettant de définir des schémas GraphQL et [d’utiliser des annotations](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) comme `@QueryMapping` et `@MutationMapping`.  
