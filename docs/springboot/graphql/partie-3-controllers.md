...
permalink: "/springboot/graphql/partie-3-controllers/"
...
L’heure est venue de bâtir les fondations de notre [API GraphQL](/definition/graphql-definition/) avec Spring Boot. Ce jour, nous allons forger nos entités [Java](https://www.sfeir.dev/back/le-langage-java-definition/), qui se dresseront fièrement en miroir des types définis dans notre schéma. Nous érigerons ensuite nos contrôleurs, équipés des [annotations puissantes](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) que Spring for GraphQL met à notre disposition.
...
## Précédémment
[Partie 2 - le schéma dans GraphQL](/springboot/graphql/partie-2-le-schema-dans-graphql/)
