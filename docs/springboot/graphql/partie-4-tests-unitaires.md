...
permalink: "/springboot/graphql/partie-4-tests-unitaires/"
...
Dans notre classe de test, [plusieurs annotations](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) nous servent de balises dans cette aventure :
