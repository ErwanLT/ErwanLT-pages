...
permalink: "/springboot/messaging/implementation-d-un-systeme-de-notifications-en-temps-reel-avec-spring-boot-et-server-sent-events/"
tags: [back, java, spring-boot, sse, notifications, tutoriel, messaging]
source: "sfeir.dev"
...
[Spring Boot](/springboot/il-etait-une-fois-spring-boot/) expose SSE via la classe `SseEmitter`. L’idée est :
...
2. [**Sécuriser les endpoints**](https://www.sfeir.dev/tag/spring-security/) :  
    Exemple avec un filtre simple ([JWT](/springboot/security/securisez-vos-api-avec-spring-security-jwt/), token ou [Basic Auth](/springboot/security/securisez-vos-api-avec-spring-security-basic-auth/) selon le contexte)
