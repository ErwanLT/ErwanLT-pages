...
permalink: "/springboot/messaging/integration-de-jms-dans-une-application-spring-boot/"
tags: [back, java, spring-boot, messaging, jms, tutoriel]
source: "sfeir.dev"
...
- **Performances limitées** pour certains cas d’usage à très fort volume ([Kafka](/springboot/messaging/integration-de-kafka-dans-une-application-spring-boot/) sera alors plus adapté).
...
L’intégration de JMS dans une application **Spring Boot** permet de bénéficier d’une communication asynchrone fiable, reposant sur un standard éprouvé. Grâce à l’écosystème Spring, la mise en place est grandement simplifiée : quelques propriétés, une classe de configuration et des [services annotés](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) suffisent pour envoyer et consommer des messages.
