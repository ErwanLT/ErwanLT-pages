...
permalink: "/springboot/messaging/integration-de-kafka-dans-une-application-spring-boot/"
...
Dans cet article, nous allons voir comment intégrer Kafka dans une application [Spring Boot](/springboot/il-etait-une-fois-spring-boot/) à travers un exemple concret comprenant un **producer** (émetteur de messages) et un **consumer** (lecteur de messages).
...
- **ConcurrentKafkaListenerContainerFactory** :
    - Fabrique les conteneurs qui gèrent l’exécution [des méthodes annotées](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/) avec `@KafkaListener`.
...
- **Monitoring** : suivre lag, performances et santé du cluster via [Prometheus/Grafana](/springboot/superviser-votre-application-spring-boot-grace-a-prometheus-et-grafana/).
