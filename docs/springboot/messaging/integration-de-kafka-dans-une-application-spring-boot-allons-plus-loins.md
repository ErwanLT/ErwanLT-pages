...
permalink: "/springboot/messaging/integration-de-kafka-dans-une-application-spring-boot-allons-plus-loins/"
tags: [spring-boot, java, tutoriel, messaging]
---
Dans [l'article précédent](/springboot/messaging/integration-de-kafka-dans-une-application-spring-boot/), nous avons vu comment intégré facilement [Kafka](https://www.sfeir.dev/data/kesaco-apache-kafka/) dans une application [spring boot](/springboot/il-etait-une-fois-spring-boot/).
