...
permalink: "/springboot/gerer-et-superviser-ses-applications-avec-spring-boot-admin/"
tags: [back, java, spring-boot, monitoring, tutoriel]
source: "sfeir.dev"
...
- **Moins robuste pour l’analyse avancée** : Bien qu’efficace pour le monitoring de base, il manque de capacités d’analyse approfondie par rapport à des outils comme [Grafana ou Prometheus](/springboot/superviser-votre-application-spring-boot-grace-a-prometheus-et-grafana/).
...
il ne reste plus qu'à rajouter [l'annotation](/springboot/comprendre-les-annotations-dans-spring-boot-guide-et-exemples/)`@EnableAdminServer` dans votre classe main
...
Dans le cas de **spring-batch tutorial**, [nous avions précédemment programmé des tâches](/springboot/planifier-des-taches-avec-spring-batch/), nous pouvons les retrouver dans le sous-menu **Tâches programmées**.
