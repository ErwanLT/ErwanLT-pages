...
permalink: "/springboot/internationalisation-i18n-et-localisation-l10n-avec-spring-boot-comment-rendre-vos-applications-multilingues/"
tags: [back, java, spring-boot, i18n, internationalisation, l10n, tutoriel]
source: "sfeir.dev"
...
Avec [**Spring Boot**](/springboot/il-etait-une-fois-spring-boot/), l’i18n se configure facilement grâce aux fichiers de propriétés et à la classe `MessageSource`.  
...
Spring met à disposition `@ControllerAdvice` pour [centraliser la gestion des erreurs](/springboot/comment-bien-gerer-ses-exceptions-dans-spring-boot/).  
...
Et pour transformer notre `User` en `UserDto` [nous utiliserons un mapper](/springboot/mapstruct-dites-adieu-au-code-repetitif-et-boostez-vos-mappages-java/) :
