...
permalink: "/springboot/httpexchange-vs-openfeign-le-match-des-clients-http/"
tags: [back, java, spring-boot, http, openfeign, httpexchange, tutoriel]
source: "sfeir.dev"
...
- générer des clients depuis OpenAPI : [Générer vos clients d'API à partir de leur spécification OpenAPI](/springboot/generer-vos-clients-d-api-a-partir-de-leur-specification-openapi/)
- gérer les erreurs correctement : [Vers un standard des erreurs HTTP](/springboot/vers-un-standard-des-erreurs-http/)
- résilience : [Résilience applicative avec Resilience4j et Spring Boot](/springboot/testing/resilience-applicative-avec-resilience4j-et-spring-boot/)
