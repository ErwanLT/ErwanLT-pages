---
layout: "default"
title: "IA generative vs Advent of code"
permalink: "/ia/ia-generative-vs-advent-of-code/"
tags: [ia generative, algorithmes, adventofcode, ia]
source: "sfeir.dev"
source_url: "https://www.sfeir.dev/ia/ia-generative-vs-advent-of-code/"
banner: "https://images.unsplash.com/photo-1606482512676-255bf02be7cf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMTc3M3wwfDF8c2VhcmNofDR8fGFkdmVudHxlbnwwfHx8fDE2OTg0MDI4NDR8MA&ixlib=rb-4.0.3&q=80&w=2000"
published_at: "2023-12-01"
sfeir_slug: "ia-generative-vs-advent-of-code"
date: "2023-12-01"
---
Le 1er décembre au matin, petits et grands ouvrent leurs calendriers de l'Avent. Si la plupart contiennent des friandises chocolatées, certains proposent un défi bien différent : se creuser la cervelle avec des problèmes [**algorithmique**](https://www.sfeir.dev/recrutement-rh/que-retenir-de-lalgorithmique/)**s**.

Mais la question de l['IA générative](https://www.wenvision.com/ia-generative-generative-ai/?ref=sfeir.dev), ce domaine de l'intelligence artificielle axé sur la création de modèles capables de générer du contenu de manière autonome, pourrait compliquer ce traditionnel défi. Pour rappel, ces modèles, qui utilisent des réseaux de neurones, produisent des textes, des images, des vidéos et d'autres types de données. Les **GAN** (Generative Adversarial Networks) et les modèles de langage comme GPT-3 sont des exemples populaires dans ce domaine. Depuis le début de l'année, l'essor de l'IA générative est indéniable et a marqué le monde numérique dans divers domaines tels que :

- Du **texte** : [ChatGPT](https://openai.com/blog/chatgpt?ref=sfeir.dev), XLNet, [Bard](https://bard.google.com/?ref=sfeir.dev) ...
- De **l'image** : [DALL-E,](https://openai.com/dall-e-3?ref=sfeir.dev) [Midjourney](https://www.midjourney.com/?ref=sfeir.dev) ...
- De **la musique** : [Aiva](https://www.aiva.ai/?ref=sfeir.dev), [Boomy](https://www.sfeir.dev/ia/lia-generative-avec-boomy-a-loccasion-de-la-fete-de-la-musique/) ...
- Du **code** : [Github Copilot](https://github.com/features/copilot?ref=sfeir.dev), ChatGPT

## **L'advent of code**

L'Advent of Code est un défi de programmation en ligne annuel créé par [Eric Wastl](https://twitter.com/ericwastl?ref=sfeir.dev). Chaque année, du 1er au 25 décembre, une nouvelle énigme de programmation est publiée chaque jour à 6 heures (heure de Paris) sur le site web de l'[Advent of Code](https://adventofcode.com/?ref=sfeir.dev). Les participants sont alors invités à résoudre ces énigmes en utilisant des compétences en programmation et en résolution de problèmes.
...
2. **Entrée** : pour chaque problème, un jeu de données qui vous est propre vous sera fourni.
3. **Objectif** : Le problème définit clairement ce que vous devez accomplir. Cela peut être de calculer une valeur, de trouver une séquence de chiffres, de déterminer un résultat, etc.

> **How many measurements are larger than the previous measurement?**

4. **Exemple** : Souvent, un exemple illustré est donné pour vous montrer comment résoudre le problème pour une petite partie des données d'entrée.  
    ![Capture d’écran 2023-11-02 à 16.35.35.png](https://www.sfeir.dev/content/images/2023/11/Capture-d-e-cran-2023-11-02-a--16.35.35.png)
5. **Partie 1 et Partie 2** : La plupart des problèmes de l'Advent of Code ont deux parties. La première partie est généralement plus simple et vous permet de progresser. La seconde est souvent une extension plus complexe du problème initial.
6. **Solution** : Vous devez mettre en œuvre une solution en utilisant un langage de programmation de votre choix pour résoudre le problème (votre input n'étant propre qu'à vous, la solution du voisin ne sera pas la même que la vôtre).
7. **Validation** : Vous soumettez votre solution pour validation sur le site web de l'Advent of Code, qui vérifie si elle est correcte.  
    ![Capture d’écran 2023-11-02 à 16.41.10.png](https://www.sfeir.dev/content/images/2023/11/Capture-d-e-cran-2023-11-02-a--16.41.10.png)
...
[![](https://www.sfeir.dev/content/images/2023/11/Capture-d-e-cran-2023-11-03-a--11.02.58.png)](https://www.sfeir.dev/content/images/2023/11/Capture-d-e-cran-2023-11-03-a--11.02.58.png)
...
- **Tester les éditions précédente** : Les éditions précédentes sont toujours disponible sur le [site](https://adventofcode.com/2023/events?ref=sfeir.dev) de l'Advent of code. En parcourant les problèmes des années précédentes, vous aurez un bon échantillon des types de problèmes proposés.

[![](https://www.sfeir.dev/content/images/2023/11/Capture-d-e-cran-2023-11-10-a--09.56.48.png)](https://www.sfeir.dev/content/images/2023/11/Capture-d-e-cran-2023-11-10-a--09.56.48.png)

éditions de l'Advent of code

- **Optimiser votre code** : Si vous avez explorer les éditions précédentes pour vous préparez, vous avez dû vous rendre compte que certains types de problème reviennent régulièrement (ex : [distance de Manhattan](https://fr.wikipedia.org/wiki/Distance_de_Manhattan?ref=sfeir.dev), [jeu de la vie](https://fr.wikipedia.org/wiki/Jeu_de_la_vie?ref=sfeir.dev) ...), et il est probable que vous n'ayez pas forcément envie de ré-écrire constamment le même code. Il est donc judicieux de créer des classes utilitaires qui seront réutilisables.
