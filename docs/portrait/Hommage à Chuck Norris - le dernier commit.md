---
layout: "default"
title: "Hommage à Chuck Norris - le dernier commit"
permalink: "/portrait/hommage-a-chuck-norris-le-dernier-commit/"
tags: [portrait]
source_url: "https://www.sfeir.dev/tendances/hommage-a-chuck-norris-le-dernier-commit/"
sfeir_slug: "hommage-a-chuck-norris-le-dernier-commit"
sfeir_tags: ""
---
Cette semaine, le monde de la tech ne vient pas de perdre un simple utilisateur… mais son **admin root**.

Chuck Norris n’écrivait pas de code. Il regardait un repository, et le code apparaissait, propre, testé, documenté. Sur GitHub, il n’avait pas besoin de pull request : c’était le _main_ qui se mettait à jour pour correspondre à sa vision.

Mais **Chuck Norris a fait un `shutdown -h now` sur lui-même** vendredi 20 mars 2026.

[![](https://media.tenor.com/6jZ1lFeBAH0AAAAC/bow-cordell-walker.gif)](https://media.tenor.com/6jZ1lFeBAH0AAAAC/bow-cordell-walker.gif)

Chuck Norris a tiré sa révérence vendredi 20 Mars 2026

## Chuck Norris et Git

Chuck Norris n’utilisait pas Git comme les autres. Il ne faisait pas de pull request : le _main branch_ se mettait à jour de lui-même pour refléter sa volonté.
...
[ERROR] Humanity downgraded.
```

Dans chaque système stable,  
