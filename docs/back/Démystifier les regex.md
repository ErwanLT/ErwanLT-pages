...
Dans les années 1980, le langage Perl dope leur puissance avec des fonctionnalités comme les groupes de capture, influençant leur adoption dans [Python](https://www.sfeir.dev/kesaco-python/), [JavaScript](https://www.sfeir.dev/javascript-definition/), [[Il était une fois... Java|Java]] et d’autres langages.
