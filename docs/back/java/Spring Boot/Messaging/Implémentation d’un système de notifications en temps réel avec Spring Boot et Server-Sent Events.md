...
[Spring Boot](/back/java/spring-boot/il-etait-une-fois-spring-boot/) expose SSE via la classe `SseEmitter`. L’idée est :
...
2. [**Sécuriser les endpoints**](https://www.sfeir.dev/tag/spring-security/) :  
    Exemple avec un filtre simple ([JWT](/back/java/spring-boot/securite/securisez-vos-api-avec-spring-security-jwt/), token ou [Basic Auth](/back/java/spring-boot/securite/securisez-vos-api-avec-spring-security-basic-auth/) selon le contexte)
