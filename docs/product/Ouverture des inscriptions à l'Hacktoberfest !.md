---
layout: "default"
title: "Ouverture des inscriptions à l'Hacktoberfest !"
permalink: "/product/ouverture-des-inscriptions-a-l-hacktoberfest/"
tags: [product]
date: "2023-09-27"
source: "sfeir.dev"
source_url: "https://www.sfeir.dev/front/hacktoberfest/"
banner: "https://www.sfeir.dev/content/images/2023/09/hf10_banner_1032x600.png"
published_at: "2023-09-27"
sfeir_slug: "hacktoberfest"
sfeir_tags: [Tendances, Front, Back, Product, hacktoberfest]
---
Hacktoberfest ? Mais ce n'est pas plutôt [l'Oktoberfest](https://fr.wikipedia.org/wiki/Oktoberfest?ref=sfeir.dev), la célèbre fête de la bière que l'on célèbre en octobre ?  
...
Pour participer à l'Hacktoberfest rien de plus simple, il suffit de se rendre à l'adresse suivante [https://hacktoberfest.com/participation/](https://hacktoberfest.com/participation/?ref=sfeir.dev) et de s'inscrire entre le **26 septembre** et le **31 octobre** avec son Github ou Gitlab.  
Une fois cela fait, dès que le compte à rebours arrive à zéro, vous pourrez commener à envoyer vos **merge request**.

[![](https://www.sfeir.dev/content/images/2023/09/image.png)](https://www.sfeir.dev/content/images/2023/09/image.png)

compte à rebours Hacktoberfest

Envoyer des merges request ? Mais comment on peut savoir sur quels projets contribuer ? Là encore, c'est très simple, il suffit d'aller sur [Github](https://github.com/topics/hacktoberfest?ref=sfeir.dev) ou [Gitlab](https://gitlab.com/explore/projects/topics/hacktoberfest?ref=sfeir.dev) et trouver des projets qui ont le tag #Hacktoberfest.  
...
![exemple d'issues sur un projet Github](https://www.sfeir.dev/content/images/2023/09/Capture-d-e-cran-2023-09-06-a--18.08.45.png "issues")
