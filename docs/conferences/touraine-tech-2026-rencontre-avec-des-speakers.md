---
layout: "default"
title: "Touraine Tech 2026 : rencontre avec des speakers"
permalink: "/conferences/touraine-tech-2026-rencontre-avec-des-speakers/"
tags: [speaker, conference, talk, conferences]
source: "sfeir.dev"
source_url: "https://www.sfeir.dev/touraine-tech-rencontre-avec-des-speakers/"
banner: "https://www.sfeir.dev/content/images/size/w1304/2026/02/logo--1-.svg"
published_at: "2026-03-17"
sfeir_slug: "touraine-tech-rencontre-avec-des-speakers"
date: "2026-03-17"
---
## 🎙 Interview d’Estelle Landry

[![](https://www.sfeir.dev/content/images/2026/02/image.png)](https://www.sfeir.dev/content/images/2026/02/image.png)

Estelle Landry

Estelle Landry est actuellement Product Manager chez [**Tutteo**](https://www.tutteo.com/fr/?ref=sfeir.dev), et travaille sur l'outil [Flat.io](https://flat.io/fr?ref=sfeir.dev) une application collaborative d’édition de partitions musicales, comparable à un Google Docs dédié à la musique.
...
Avec [Pix](https://pix.fr/?ref=sfeir.dev), nous avons contribué à créer un outil pédagogique pour apprendre les bons gestes numériques.  
...
[![](https://www.sfeir.dev/content/images/2026/02/image-1.png)](https://www.sfeir.dev/content/images/2026/02/image-1.png)
...
Je suis freelance, principalement en architecture logicielle, orienté back-end [Java](https://www.sfeir.dev/back/le-langage-java-definition/), avec une forte composante cloud et DevOps.  
Je travaille en région lilloise, surtout avec des entreprises locales comme Auchan, Leroy Merlin ou Decathlon.

En ce moment, je suis chez Electro Dépôt où je participe à la refonte d’un ancien système de caisse développé en AS/400 vers une stack moderne : [Java](https://www.sfeir.dev/back/il-etait-une-fois-java/), [Angular](https://www.sfeir.dev/front/kesaco-angular/), hébergement Azure. C’est un projet conséquent.
...
Je suis également impliqué dans l’organisation d’une [conférence technique](https://cloudnord.fr/?ref=sfeir.dev) (nous préparons actuellement la 7ᵉ édition prévue en octobre).

Enfin, j’enseigne à l’Université de Lille depuis une douzaine d’années, principalement [Java](https://www.sfeir.dev/back/java-26-quoi-de-neuf/) et [Spring Boot](https://www.sfeir.dev/back/il-etait-une-fois-spring-boot/) en Master 2, avec des approches modernes comme l’architecture hexagonale.
...
Je joue à [Factorio](https://factorio.com/?ref=sfeir.dev) depuis très longtemps, avant même sa sortie officielle sur Steam. Ça doit faire une dizaine d’années.
