---
layout: "default"
title: "JUG Summer Camp 2025 - le récap complet de l’édition de La Rochelle"
permalink: "/conferences/jug-summer-camp-2025-le-recap-complet-de-l-edition-de-la-rochelle/"
tags: [conference, java, architecture decision records, back, quantique, ia, jug summer camp 2025, adr, conferences]
source: "sfeir.dev"
source_url: "https://www.sfeir.dev/back/jug-summer-camp-2025-le-recap-complet-de-ledition-de-la-rochelle/"
banner: "https://www.sfeir.dev/content/images/2025/09/jsc-opengraph-1-1.png"
published_at: "2025-09-08"
sfeir_slug: "jug-summer-camp-2025-le-recap-complet-de-ledition-de-la-rochelle"
date: "2025-09-08"
---
...
![](https://www.sfeir.dev/content/images/thumbnail/jsc-opengraph.png)

](https://www.jugsummercamp.org/edition/16?ref=sfeir.dev)
...
Bienvenue au Paris JUG Le Paris JUG est un groupe d’utilisateurs Java ayant pour but de réunir les acteurs du langage (professionnels, communautés open source, institutions, étudiants, enseignants…) afin d’échanger des idées et de discuter des avancées technologiques de la plateforme Java. Nous nous rencontrons le deuxième mardi du mois. Les réunions sont gratuites, ouvertes à tous et consistent en une présentation technique, une démonstration d’un produit, ou une table ronde. Après la réunion nous nous retrouvons généralement pour un échange informel autour d’un verre et d’un petit buffet.

![](https://www.sfeir.dev/content/images/icon/favicon-16.ico)Paris Java User Group

![](https://www.sfeir.dev/content/images/thumbnail/featured.png)

](https://www.parisjug.org/?ref=sfeir.dev)
...
### Keynote d'ouverture Plongez dans l'ère quantique - [Fanny Bouton](https://www.linkedin.com/in/fannybouton/?originalSubdomain=fr&ref=sfeir.dev)

[![](https://www.sfeir.dev/content/images/2025/09/IMG_4292.jpeg)](https://www.sfeir.dev/content/images/2025/09/IMG_4292.jpeg)
...
![](https://www.sfeir.dev/content/images/icon/plume-point-226.png)sfeir.dev - Le média incontournable pour les passionnés de tech et d'intelligence artificielleThibaut Rety

![](https://www.sfeir.dev/content/images/thumbnail/AdobeStock_57315138-1.jpeg)

](https://www.sfeir.dev/tendances/strange-un-etrange-framework-java-de-programmation-quantique/)

### II. Multi-Tenant : Là où on va, on n'a pas besoin de routes (ni de Multi-Instance) ! - [Sébastien Coulle](https://www.sfeir.dev/author/sebastien/)
...
### III. Déchaînez le Chaos : Tester la résilience de votre application avec Chaos Monkey - [Erwan Le Tutour](https://www.sfeir.dev/author/erwan/)
...
Talk d'Erwan Le Tutour au JUG Summer Camp 2025

Pour en savoir plus sur le sujet c'est par ici 👇🏻

[Introduisez du chaos dans votre application Spring Boot](/springboot/testing/introduisez-du-chaos-dans-votre-application-spring-boot/)
...
Avec l'adoption exponentielle des serveurs [MCP](https://www.sfeir.dev/mcp-model-context-protocol-la-cle-pour-connecter-les-ia-au-monde-reel-2/) (Model Context Protocol), Horacio nous rappelle quelques règles de "bonne conduite". L'enseignement principal est clair : **les serveurs MCP doivent être conçus comme des API**, avec une attention particulière portée à la sécurité, la gouvernance et la spécificité du domaine. L'utilisation de serveurs génériques est à proscrire en production, au profit d'implémentations sur mesure, garantissant ainsi un contrôle optimal.

### V. Maman, j'ai développé un synthétiseur dans mon navigateur ! 😱 🎹 🎵 - [Benjamin Legrand](https://www.linkedin.com/in/benjilegnard/?ref=sfeir.dev)

[![](https://www.sfeir.dev/content/images/2025/09/IMG_4293.jpeg)](https://www.sfeir.dev/content/images/2025/09/IMG_4293.jpeg)
